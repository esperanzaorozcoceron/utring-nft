...
async function renderToHTML(req, res, pathname, query, renderOpts) {
    ...
    const { err , dev =false , ampPath ='' , App , pageConfig ={} , buildManifest , fontManifest , reactLoadableManifest , ErrorDebug , getStaticProps , getStaticPaths , getServerSideProps , serverComponentManifest , serverComponentProps , isDataReq , params , previewProps , basePath , devOnlyCacheBusterQueryString , supportsDynamicHTML , images , // reactRoot,
    runtime , ComponentMod , AppMod ,  } = renderOpts;
