...
async function getBaseWebpackConfig(dir, { buildId , config , dev =false , isServer =false , isEdgeRuntime =false , pagesDir , target ='server' , reactProductionProfiling =false , entrypoints , rewrites , isDevFallback =false , runWebpackSpan  }) {
    var ref35, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ref10, ref11, ref12, ref13, ref14, ref15, ref16, ref17, ref18, ref19;
    ...
    if (useSWCLoader) {
        var ref20, ref21, ref22;
        // TODO: we do not collect wasm target yet
        const binaryTarget = (ref20 = require('./swc')) === null || ref20 === void 0 ? void 0 : (ref21 = ref20.getBinaryMetadata) === null || ref21 === void 0 ? void 0 : (ref22 = ref21.call(ref20)) === null || ref22 === void 0 ? void 0 : ref22.target;
    ...
    const looseEsmExternals = ((ref35 = config.experimental) === null || ref35 === void 0 ? void 0 : ref35.esmExternals) === 'loose';
    ...
    if (resolvedBaseUrl) {
        var ref23, ref24;
        (ref23 = webpackConfig.resolve) === null || ref23 === void 0 ? void 0 : (ref24 = ref23.modules) === null || ref24 === void 0 ? void 0 : ref24.push(resolvedBaseUrl);
    }
    if ((jsConfig === null || jsConfig === void 0 ? void 0 : (ref10 = jsConfig.compilerOptions) === null || ref10 === void 0 ? void 0 : ref10.paths) && resolvedBaseUrl) {
        var ref25, ref26;
        (ref25 = webpackConfig.resolve) === null || ref25 === void 0 ? void 0 : (ref26 = ref25.plugins) === null || ref26 === void 0 ? void 0 : ref26.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin(jsConfig.compilerOptions.paths, resolvedBaseUrl));
    }
    ...
    const cache = {
        ...
        version: `${"12.1.1-canary.17"}|${configVars}`,
    ...
    if (typeof config.webpack === 'function') {
        ...
        if (((ref27 = webpack5Config.experiments) === null || ref27 === void 0 ? void 0 : ref27.lazyCompilation) === true) {
            webpack5Config.experiments.lazyCompilation = {
                entries: false
            };
        } else if (typeof ((ref28 = webpack5Config.experiments) === null || ref28 === void 0 ? void 0 : ref28.lazyCompilation) === 'object' && webpack5Config.experiments.lazyCompilation.entries !== false) {
    ...
    if (!config.images.disableStaticImages) {
        var ref29;
        const rules = ((ref29 = webpackConfig.module) === null || ref29 === void 0 ? void 0 : ref29.rules) || [];
    ...
    if (config.experimental.craCompat && ((ref18 = webpackConfig.module) === null || ref18 === void 0 ? void 0 : ref18.rules) && webpackConfig.plugins) {
    ...
    var ref30;
    const hasUserCssConfig = (ref30 = (ref19 = webpackConfig.module) === null || ref19 === void 0 ? void 0 : ref19.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include)
    )) !== null && ref30 !== void 0 ? ref30 : false;
    if (hasUserCssConfig) {
        var ref31, ref32, ref33, ref34;
        ...
        if ((ref31 = webpackConfig.module) === null || ref31 === void 0 ? void 0 : ref31.rules.length) {
        ...
        if ((ref32 = webpackConfig.plugins) === null || ref32 === void 0 ? void 0 : ref32.length) {
            // Disable CSS Extraction Plugin
            webpackConfig.plugins = webpackConfig.plugins.filter((p)=>p.__next_css_remove !== true
            );
        }
        if ((ref33 = webpackConfig.optimization) === null || ref33 === void 0 ? void 0 : (ref34 = ref33.minimizer) === null || ref34 === void 0 ? void 0 : ref34.length) {
