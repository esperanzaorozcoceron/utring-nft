...
function getBaseSWCOptions({ filename , jest , development , hasReactRefresh , globalWindow , nextConfig , resolvedBaseUrl , jsConfig ,  }) {
    ...
    return {
        ...
        relay: nextConfig === null || nextConfig === void 0 ? void 0 : (ref8 = nextConfig.compiler) === null || ref8 === void 0 ? void 0 : ref8.relay,
        emotion: getEmotionOptions(nextConfig, development)
    };
}
function getEmotionOptions(nextConfig, development) {
    var ref, ref9, ref10, ref11, ref12, ref13, ref14;
    if (!(nextConfig === null || nextConfig === void 0 ? void 0 : (ref = nextConfig.experimental) === null || ref === void 0 ? void 0 : ref.emotion)) {
        return null;
    }
    let autoLabel = false;
    switch(nextConfig === null || nextConfig === void 0 ? void 0 : (ref9 = nextConfig.experimental) === null || ref9 === void 0 ? void 0 : (ref10 = ref9.emotion) === null || ref10 === void 0 ? void 0 : ref10.autoLabel){
        case 'never':
            autoLabel = false;
            break;
        case 'always':
    ...
    return {
        enabled: true,
        autoLabel,
        labelFormat: nextConfig === null || nextConfig === void 0 ? void 0 : (ref11 = nextConfig.experimental) === null || ref11 === void 0 ? void 0 : (ref12 = ref11.emotion) === null || ref12 === void 0 ? void 0 : ref12.labelFormat,
        sourcemap: development ? (ref15 = nextConfig === null || nextConfig === void 0 ? void 0 : (ref13 = nextConfig.experimental) === null || ref13 === void 0 ? void 0 : (ref14 = ref13.emotion) === null || ref14 === void 0 ? void 0 : ref14.sourceMap) !== null && ref15 !== void 0 ? ref15 : true : false
    };
}
